...
/** \mainpage RoboComp::grid2D
 *
 * \section intro_sec Introduction
 *
 * The grid2D component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/grid2D --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class grid2D : public RoboComp::Application
{
public:
	grid2D (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::grid2D::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::grid2D app(prefix, startup_check_flag);
