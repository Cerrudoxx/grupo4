...
/** \mainpage RoboComp::obs_person_tracker
 *
 * \section intro_sec Introduction
 *
 * The obs_person_tracker component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/obs_person_tracker --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class obs_person_tracker : public RoboComp::Application
{
public:
	obs_person_tracker (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::obs_person_tracker::initialize()
{
...
int ::obs_person_tracker::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::obs_person_tracker app(prefix, startup_check_flag);
